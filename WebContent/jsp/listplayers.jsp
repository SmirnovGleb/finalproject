...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/listplayers/jquery.dataTables.min.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/listplayers/listplayers.css">
	</head>
  <body>
    <div class="container">
		        ...
		        <tbody>
		            <c:forEach var="player" items="${listplayers}">	
					   	<tr>
		                         ...
		                         <td></td>
		                         <td>
		                         	 <form id="blockform" action="/Roulette/Controller" method="post">
							            ...
							            <input type="hidden" name="command" value="lockplayer">
    ...
    'use strict';
	var $ = jQuery;
	$.getScript("${pageContext.request.contextPath}/js/listplayers/datatables.min.js", function(){
            $('#example').DataTable( {
                "paging":   true,
                "ordering": true,
                "info":     false
