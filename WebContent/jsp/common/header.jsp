		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
				<ul class="nav navbar-nav">
					<li class="active"><a href="${pageContext.request.contextPath}/Controller?command=account"><fmt:message key="user.account"/></a></li>
					...
					<li><a href="${pageContext.request.contextPath}/Controller?command=logout"><fmt:message key="user.logout"/></a></li>
					<li>
						<div class="sele">
