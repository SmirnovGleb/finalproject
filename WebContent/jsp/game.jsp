...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/game/table.css">
	    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/game/chips.css">
	    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/game/global.css">    
	</head>
	...
	<body>
	    ...
	    <script src="${pageContext.request.contextPath}/js/game/bootstrap.min.js"></script>
	    <script src="${pageContext.request.contextPath}/js/game/jquery.keyframes.min.js"></script>
